<?php require views_path('partials/header');?>
	...
	<div class="container-fluid border rounded p-4 m-2 col-lg-4 mx-auto">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
			  <label for="lot" class="form-label">Lot<small class="text-muted"> (optional)</small></label>
			  <input name="lot" type="text" class="form-control <?=!empty($errors['lot']) ? 'border-danger':''?>" id="lot" placeholder="ARRIVAGE">
            ...
            <br>
			<div class="mb-3">
			  <label for="shop" class="form-label">Shop <small class="text-muted">(optional) 2.Maurice</small></label>
			  <input name="shop" type="text" class="form-control <?=!empty($errors['shop']) ? 'border-danger':''?>" id="shop" value="2">
