...
<?php if(is_array($obj)):?>
	...
	<table class="table table-striped">
		<tr>
			<th>Qte</th><th>Description</th><th>@</th><th>Prix</th>
		</tr>
		...
		<tr>
			<td colspan="2"></td><td>Total payer:</td><td><?=$obj['amount']?></td>
		</tr>
		<tr>
			<td colspan="2"></td><td>Retour:</td><td><?=$obj['change']?></td>
		</tr>
		
		
	</table>

	<center><p><i>Merci pour votre confiance!</i></p></center>
<?php endif;?>
