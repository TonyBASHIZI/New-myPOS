...
<div class="table-responsive">
	<h2>Total vente du jours: $<?=number_format($sales_total,2)?></h2>
	<table class="table table-striped table-hover">
		<tr>
			<th>Barcode</th><th>Facture No</th><th>Description</th><th>Qte</th><th>Prix u</th><th>Total</th><th>Caissier</th><th>Date</th>
			<th>
				<a href="index.php?pg=home">
					<button class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Ajouter facture</button>
				</a>
			</th>
